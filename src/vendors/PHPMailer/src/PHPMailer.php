...
class PHPMailer
{
    ...
    /**
     * Set the app and private key files and password for S/MIME signing.
     *
    ...
    /**
     * Allows for app read access to 'to' property.
    ...
    /**
     * Allows for app read access to 'cc' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
    ...
    /**
     * Allows for app read access to 'bcc' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
    ...
    /**
     * Allows for app read access to 'ReplyTo' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
    ...
    /**
     * Allows for app read access to 'all_recipients' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
